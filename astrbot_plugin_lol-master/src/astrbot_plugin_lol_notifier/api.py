...
async def close_session() -> None:
    """关闭 HTTP 连接池。"""
    from .fetcher.lolesports import close_session as _close
...
async def get_schedule(
    ...
    from .fetcher.lolesports import fetch_schedule
...
async def get_match_bp(
    ...
    from .fetcher.lolesports import fetch_match_detail, fetch_schedule
...
async def get_standings(
    ...
    from .fetcher.lolesports import fetch_standings
